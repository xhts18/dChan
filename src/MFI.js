    ...
    render(){
        return(
           ...
           <LineChart width={graphWidth} height={graphHeight} data={this.state.response} margin={{top: 5, right: 30, left: 0, bottom: 5}}>
                  ...
                  <Line type="monotone" dataKey={mfiMetric} stroke="blue" activeDot={{r: 8}} dot = {<CustomDot/>}/>
